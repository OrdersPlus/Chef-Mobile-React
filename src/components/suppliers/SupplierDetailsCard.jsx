...
const SupplierDetailsCard = ({ details }) => {
  ...
  const businessDays = JSON.parse(details?.data?.business_days || "{}");
  console.log(Object.entries(businessDays));
  return (
    <div className="m-2 p-4 rounded-md bg-[var(--secondary-color)] shadow-md space-y-4 mb-2 mt-3">
      <div
        className="bg-[var(--secondary-color)] p-4 rounded-lg shadow"
        style={{
      ...
      >
        <div className="flex  items-center">
          ...
          <FaLink className="text-blue-500" size="2em" />
        </div>
        <div
          className="flex flex-col mb-6 justify-between items-center bg-[var(--secondary-color)] p-2 rounded-lg shadow "
          style={{
            boxShadow: "inset 0px 0px 3px #d1d1d1, 1px 1px 8px #54545466",
          }}
        >
          <span className="font-semibold text-gray-600">
            Supplier's Business Information
          </span>
        </div>
        ...
        <div className="mb-6 ">
          ...
          <div className="mt-2 flex justify-between">
            <div
              className="flex  flex-col items-between text-sm text-gray-600 bg-[var(--secondary-color)] p-5 rounded-lg shadow"
              style={{
                boxShadow: "inset 0px 0px 3px #d1d1d1, 1px 1px 8px #54545466",
              }}
            >
            ...
            <div
              className="flex flex-col justify-between text-sm text-gray-600 bg-[var(--secondary-color)] p-5 rounded-lg shadow"
              style={{
                boxShadow: "inset 0px 0px 3px #d1d1d1, 1px 1px 8px #54545466",
              }}
            >
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-4 sm:grid-cols-4 lg:grid-cols-7 gap-2 mt-6">
            {Object.entries(businessDays || {}).map(([day, isOpen], index) => (
              <button
                key={index}
                className={`text-[var(--text-secondary)] text-lg rounded-lg py-3 shadow-2xl ${
                  isOpen ? "bg-green-500" : "bg-[var(--primary-color)]"
                }`}
              >
                {day}
              </button>
        ...
        <div className="mb-6 ">
          ...
          <div
            className="bg-[var(--secondary-color)] p-4 rounded-xl shadow-md border border-gray-200"
            style={{
              boxShadow: "inset 0px 0px 3px #d1d1d1, 1px 1px 8px #54545466",
            }}
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 mb-1">
                  Order before this time for same-day delivery
                </p>
                <h4 className="text-3xl font-bold text-gray-800 tracking-wider">
                  5:00 PM
                </h4>
              </div>
        ...
        <div className="mt-4">
          ...
          <div className="mt-2">
            <p className="text-sm sm:text-base">
              Only apply when order is below minimum order
            </p>
