...
export const UderWeightModal = () => {
  return (
       <dialog id="under_weight_modal" className="modal">
  <div className="modal-box">
    ...
    <h3 className="font-bold text-lg text-center mb-4">UnderWeight </h3>

    <div className="mb-4">
      <label className="block text-gray-700 mb-1">Invoice Weight</label>
      <input
        type="number"
